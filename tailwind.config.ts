...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        paper:
          "0 4px 6px -1px rgba(91, 44, 111, 0.1), 0 2px 4px -1px rgba(91, 44, 111, 0.06)",
        "paper-hover":
          "0 10px 15px -3px rgba(91, 44, 111, 0.15), 0 4px 6px -2px rgba(91, 44, 111, 0.1)",
        "paper-lg":
          "0 20px 25px -5px rgba(91, 44, 111, 0.12), 0 10px 10px -5px rgba(91, 44, 111, 0.08)"
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
